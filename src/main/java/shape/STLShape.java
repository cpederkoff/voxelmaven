...
public class STLShape extends Shape {
  ...
  private STLShape(byte[] bytes, double scale) {
    ...
    try {
      ...
      smallBounds = new double[] { bigbounds[0] / scale, bigbounds[1] / scale, bigbounds[2] / scale,
          bigbounds[3] / scale, bigbounds[4] / scale, bigbounds[5] / scale };
  ...
  private boolean intersects(Vector3d vertex1, Vector3d vertex2, Vector3d vertex3, Vector3d rayOrigin,
