...
public class VoronoiPoints {
    ...
    public Point3d[] generatePoints() {
        ...
        for (int i = 0; i < 200000; i++) {
            ...
            if (outerPoints.size() == 0) {
                outerPoints.add(point3d);
                    ...
                    && getClosestPointDist(outerPoints, point3d) > keepAway) {
                outerPoints.add(point3d);
            }
        }
        ...
        for (int i = 0; i < 20000; i++) {
            ...
            if (innerPoints.size() == 0) {
                ...
                double alldist = Math.min(
                        getClosestPointDist(innerPoints, point3d),
    ...
    private static double getClosestPointDist(List<Point3d> points,
            Point3d point3d) {
